  ...
  return (
    <main className="flex-grow flex items-center mt-4 md:mt-0 md:justify-center flex-col md:flex-row h-full">
      <div className="flex flex-col text-left md:w-[500px] pb-5 mb-5 border-b md:border-b-0 px-6">
        ...
        <CustomInput type="text" className="mb-3" placeholder="New Password"/>
        <CustomInput type="text" className="mb-3" placeholder="Repeat Password"/>
        <Button className="w-[150px] p-7 tracking-widest h-12 self-end">Confirm</Button>
      </div>
    </main>
  )
}
